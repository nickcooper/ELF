<?php
class ReportsTest extends CakeTestSuite
{
    public static function suite()
    {   
        // Here's how you would add all of the tests in the model directory
        $suite = new CakeTestSuite('All model tests for report');
        $suite->addTestDirectory(APP_DIR . DS . 'Plugin' . DS . 'Reports' . DS . 'Test' . DS . 'Case' . DS . 'Model');
