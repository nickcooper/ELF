...
<?php
echo $this->Form->create(Configure::read('acl.aro.user.model'), array('url' => array('plugin' => 'acl', 'controller' => 'aros', 'action' => 'users')));
echo __d('acl', 'name');
echo '<br/>';
echo $this->Form->input($user_display_field, array('label' => false, 'div' => false, 'class' => 'text large span-8'));
echo ' ';
echo $this->Form->end(array('label' =>__d('acl', 'filter'), 'div' => false, 'class' => 'button'));
echo '<br/>';
?>
