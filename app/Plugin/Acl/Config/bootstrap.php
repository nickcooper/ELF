...
/*
 * The model plugin name ('Users' if plugin is app/Plugin/Users/)
 * 
 * This ensures our models are loaded from the correct place. Leave blank if
 * not using a plugin.
 * 
 * Both the user and role models must be in the same plugin if using a plugin
 * for user/group management.
 */
Configure :: write('acl.model.plugin', 'Accounts');
 ...
 */
Configure :: write('acl.aro.user.model', 'Account');
 ...
 */
Configure :: write('acl.aro.role.display_field', 'label');
 ...
 */
# group id 2 = Super Admin
Configure :: write('acl.role.access_plugin_role_ids', array(2));
