<div id="pre" class="span-5">
	<div class="stationary">
		<div id="section_head" class="black-box">
			<h3><span class="pre"><?php echo __('Edit'); ?></span> <?php echo __('Course Catalog Item'); ?></h3>
		...
		<?php
	        ...
	        echo $this->Form->input(
	        	...
	        	array(
	        		...
	        		'options' => array_merge(array('' => '-- Select --'), range(1, 10)),
        		)
    		);
