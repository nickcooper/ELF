<?php
class SearchableTest extends CakeTestSuite
{
    public static function suite()
    {   
        // Here's how you would add all of the tests in the model directory
        $suite = new CakeTestSuite('All model tests for searchable');
        $suite->addTestDirectory(APP_DIR . DS . 'Plugin' . DS . 'Searchable' . DS . 'Test' . DS . 'Case' . DS . 'Model');
