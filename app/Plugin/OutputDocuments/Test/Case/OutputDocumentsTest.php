<?php
class OutputDocumentsTest extends CakeTestSuite
{
    public static function suite()
    {   
        // Here's how you would add all of the tests in the model directory
        $suite = new CakeTestSuite('All model tests for output documents');
        $suite->addTestDirectory(APP_DIR . DS . 'Plugin' . DS . 'OutputDocuments' . DS . 'Test' . DS . 'Case' . DS . 'Model');
