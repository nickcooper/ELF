    ...
    <div class="pad">
        ...
        <div class="span-8">
            <fieldset>
                ...
                ?>
                <?php echo $this->Form->input('Payment.transaction_data', array('label' => 'Name', 'class' => 'text span-7')); ?>
                <?php echo $this->Form->input('Payment.identifier', array('label' => 'Check Number', 'class' => 'text span-7')); ?>
            </fieldset>
        </div>
