...
<p>Your interim certification will expire on {$license_expire_date}.  By that date, you must be recertified by submitting proof that you have passed the Iowa-approved third-party test.  We will then extend this expiration date by six months and send you a new letter of certification and ID card.  If you do not pass the test by this date, you will have to take the entire class again before you can be certified.</p>  

<p>Also, please be aware that you are required to take a refresher course by {$refresher_end_date}.</p>

<p>Below you will find a self-laminating ID card with your certification number and expiration date.  Keep this card with you when you are at a job site.  If you have any questions, please contact us at the number below.</p>

<p>You can find the certification requirements and work practice standards for all lead professionals in Iowa Administrative Code 641 – Chapter 70, which is at: http://www.legis.state.ia.us/aspx/ACODocs/DOCS/641.70.pdf   You must be currently certified to perform work that requires certification.</p>
<p> </p>
<p> </p>
