...
<p>This is to confirm that on {$revised_date} we received a revision to the lead abatement notification for {$project_address}.  The projected start date is {$phase_1_start_date}, the end of the first abatement phase is {$phase_1_end_date}, the beginning of the second abatement phase is {$data['phase_2_start_date']}, and the project end date is {$data['phase_2_end_date']}.  If this changes again, you will need to submit another revised lead abatement notification with the new dates.</p>
