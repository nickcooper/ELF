...
$effective_date = date('F j, Y', strtotime($data['Application'][0]['effective_date']));
...
<p>Since you were late in renewing, you were not certified between {$data['license_old_expire_date']} and {$effective_date}.</p>
